...
class CuentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuentum" do
    assert_difference("Cuentum.count") do
      post cuenta_url, params: { cuentum: { cliente_id: @cuentum.cliente_id, nocuenta: @cuentum.nocuenta, saldo: @cuentum.saldo } }
    end
  ...
  test "should update cuentum" do
    patch cuentum_url(@cuentum), params: { cuentum: { cliente_id: @cuentum.cliente_id, nocuenta: @cuentum.nocuenta, saldo: @cuentum.saldo } }
